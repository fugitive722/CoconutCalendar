...
extern void *mono_aot_module_CoconutCalendar_info;
...
{
	mono_aot_register_module (mono_aot_module_CoconutCalendar_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "CoconutCalendar.exe";
	mono_use_llvm = FALSE;
